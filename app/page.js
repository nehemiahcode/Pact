        ...
        {signedin ? (
          <div className=" w-[90%] sm:w-[80%] md:w-[60%] lg:w-[50%] rounded-md mx-auto bg-slate-900 h-[300px] px-5 py-5">
            ...
            <p className="  text-md text-white text-center py-2">
              You have successfull created an account with Packt click on the
              button bellow to get started and kick start your Project.
            </p>
         <div className="  flex justify-center items-center my-4">
         <Ripples className=" mx-auto">
         <button onClick={handleNextPage} className="bg-gradient-to-br from-slate-400 to-blue-600 duration-300  font-medium rounded-md  py-2 px-4">Get Started</button>
         </Ripples>
         </div>
          </div>
        ) : (
